  ...
  return (
    <section className="about-section">
      ...
      <p className="about-text">
        Our mission at Celestius is to create a dynamic and inclusive community
        ...
        them apart in the tech world. Beyond skill-building, Celestius is a
        ...
        Joining Celestius is more than just an opportunity to develop technical
        ...
        ability to adapt and collaborate. At Celestius, we equip our members
